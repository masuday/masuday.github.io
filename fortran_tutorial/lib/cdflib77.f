C
C     A wrapping module for CDFLIB.F.
C     See http://www.netlib.org/random/dcdflib.f.tar.gz for license.
C     All subroutines are included in this module, so the all EXTERNAL
C     statements are removed (commented out).
C
      MODULE CDFLIB77
      IMPLICIT NONE
      PUBLIC
      PRIVATE :: GAMMA77, ERF77
      CONTAINS
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION bcorr,erfc1,rlog1
C      EXTERNAL bcorr,erfc1,rlog1
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION algdiv,alnrel,bcorr,gamln,gsumln
C      EXTERNAL algdiv,alnrel,bcorr,gamln,gsumln
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION algdiv,alnrel,gam1
C      EXTERNAL algdiv,alnrel,gam1
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION algdiv,betaln,gam1,gamln1
C      EXTERNAL algdiv,betaln,gam1,gamln1
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION apser,basym,bfrac,bpser,bup,fpser,spmpar
C      EXTERNAL apser,basym,bfrac,bpser,bup,fpser,spmpar
C     ..
C     .. External Subroutines ..
C      EXTERNAL bgrat
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION algdiv,alnrel,bcorr,betaln,esum,gam1,gamln1,rlog1
C      EXTERNAL algdiv,alnrel,bcorr,betaln,esum,gam1,gamln1,rlog1
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION algdiv,alnrel,bcorr,betaln,gam1,gamln1,rlog1
C      EXTERNAL algdiv,alnrel,bcorr,betaln,gam1,gamln1,rlog1
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC abs,dble,dlog,dmax1,dmin1,exp,sqrt
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION brcmp1,exparg
C      EXTERNAL brcmp1,exparg
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC abs,exp
C     ..
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL cumbet,dinvr,dstinv,dstzr,dzror
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,dstzr,dzror,cumbin
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,cumchi
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,cumchn
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,cumfnc
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL gaminv,dinvr,dstinv,cumgam
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,dstzr,dzror,cumnbn
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,cumpoi
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION spmpar,dt1
C      EXTERNAL spmpar,dt1
C     ..
C     .. External Subroutines ..
C      EXTERNAL dinvr,dstinv,cumt
C     ..
C     .. Executable Statements ..
C
C     Check arguments
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION devlpl,dln1px
C      EXTERNAL devlpl,dln1px
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC abs,log
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION devlpl,dlngam
C      EXTERNAL devlpl,dlngam
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC log
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION dinvnr,devlpl
C      EXTERNAL dinvnr,devlpl
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC abs
C     ..
...
C
   70 erfc1 = 0.0D0
      ...
      END function
      DOUBLE PRECISION FUNCTION erf77(x)
C-----------------------------------------------------------------------
...
C
   10 IF (ax.GT.4.0D0) GO TO 20
     ...
     +      p(7))*ax + p(8)
      bot = ((((((q(1)*ax+q(2))*ax+q(3))*ax+q(4))*ax+q(5))*ax+q(6))*ax+
     +      q(7))*ax + q(8)
      erf77 = 0.5D0 + (0.5D0-exp(-x*x)*top/bot)
      IF (x.LT.0.0D0) erf77 = -erf77
      RETURN
C
   20 IF (ax.GE.5.8D0) GO TO 30
      ...
      top = (((r(1)*t+r(2))*t+r(3))*t+r(4))*t + r(5)
      bot = (((s(1)*t+s(2))*t+s(3))*t+s(4))*t + 1.0D0
      erf77 = (c-top/ (x2*bot))/ax
      erf77 = 0.5D0 + (0.5D0-exp(-x2)*erf77)
      IF (x.LT.0.0D0) erf77 = -erf77
      RETURN
C
   30 erf77 = sign(1.0D0,x)
      RETURN
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION alnrel,gamln,gamln1,gamma,rcomp,spmpar
C      EXTERNAL alnrel,gamln,gamln1,gamma,rcomp,spmpar
C     ..
C     .. External Subroutines ..
C      EXTERNAL gratio
C     ..
...
C
   40 t = (1.0D0/a)**2
      ...
      END function
      DOUBLE PRECISION FUNCTION gamma77(a)
C-----------------------------------------------------------------------
C
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION exparg,spmpar
C      EXTERNAL exparg,spmpar
C     ..
C     .. Intrinsic Functions ..
...
C
      ...
      gamma77 = exp(w)* (1.0D0+t)
      IF (a.LT.0.0D0) gamma77 = (1.0D0/ (gamma77*s))/x
      RETURN
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION erf,erfc1,gam1,rexp
C      EXTERNAL erf,erfc1,gam1,rexp
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION erf,erfc1,gam1,gamma,rexp,rlog,spmpar
C      EXTERNAL erf,erfc1,gam1,gamma,rexp,rlog,spmpar
C     ..
C     .. Intrinsic Functions ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION alnrel,gamln1
C      EXTERNAL alnrel,gamln1
C     ..
C     .. Intrinsic Functions ..
      INTRINSIC dble,dlog
C     ..
...
C     ..
C     .. External Functions ..
C      DOUBLE PRECISION gam1,gamma,rlog
C      EXTERNAL gam1,gamma,rlog
C     ..
C     .. Intrinsic Functions ..
